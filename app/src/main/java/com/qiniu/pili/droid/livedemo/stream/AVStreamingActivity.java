...
public class AVStreamingActivity extends Activity implements StreamStatusCallback, StreamingSessionListener, StreamingStateChangedListener, View.OnClickListener {
    ...
    public void initCameraStreamingSetting() {
        ...
        mBeautyFB.setTitle(mIsNeedFB ? getString(R.string.stream_beauty_close) : getString(R.string.stream_beauty_open));
    ...
    public void initStreamingProfile() {
        if (mEncodingSettingModel.isDebugMode()){
    ...
    public void notifyStreamStatusChanged(final StreamingProfile.StreamStatus streamStatus) {
        runOnUiThread(new Runnable() {
            @Override
            public void run() {
                mInfoText.setText("bitrate:" + streamStatus.totalAVBitrate / 1024 + " kbps"
        ...
        new Thread(new Runnable() {
            ...
            public void run() {
                ...
                runOnUiThread(new Runnable() {
                    @Override
                    public void run() {
                        mOrientationFB.setTitle(mIsEncOrientationPort? getString(R.string.stream_landscape):getString(R.string.stream_portrait));
                    }
                });
            }
        }).start();
    ...
    public void onClickPreviewMirror(View view) {
        ...
        Util.showToast(this, getString(R.string.stream_mirror_succ));
    }
    ...
    private class ScreenShooter implements Runnable {
        @Override
        public void run() {
            final String fileName = "PLLive_" + System.currentTimeMillis() + ".jpg";
